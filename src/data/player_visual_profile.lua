...
PlayerVisualProfile.handGear = "both_hands"   -- "none", "left_hand", "right_hand", "both_hands"
PlayerVisualProfile.handGearColor = "white"   -- "white", "black", "team_primary", "team_secondary"
...
PlayerVisualProfile.handGearOptions = { "none", "left_hand", "right_hand", "both_hands" }
PlayerVisualProfile.handGearColorOptions = { "white", "black", "team_primary", "team_secondary" }
