-- src/data/defensive_schemes.lua
...
return {
    ...
    },
    {
        ...
        tier = "Pro Defense",
        icon = "def_cover2.png",
        description = "-30% Momentum on Short & Medium Passes",
        evaluate = function(playType, chips, mult)
            if playType == "Short Pass" or playType == "Medium Pass" then
                return chips, math.max(0.1, mult * 0.7)
            end
            return chips, mult
        end
    },
    ...
    },
    {
        ...
        description = "DEN '15: Debuffs WR & TE cards, disabling their passives.",
        evaluate = function(playType, chips, mult)
            return chips, mult
        end
    },
    {
        ...
        description = "CHI '85: Negates player card yardage bonuses on 3rd & 4th Down.",
        evaluate = function(playType, chips, mult)
            return chips, mult
        end
    },
    {
        ...
        tier = "All-Time Defense",
        icon = "def_blitz.png",
        description = "Play Clock drops to 8s. -10 YDS on Deep Passes.",
        evaluate = function(playType, chips, mult)
            if playType == "Deep Pass" then
                return math.max(0, chips - 10), mult
            end
            return chips, mult
        end
    },
    ...
    -- ── 6 NEW STRATEGIC BLINDS (v2.0 Update) ─────────────────────────
    {
        id = "prevent_defense",
    ...
    },
    {
        ...
        tier = "Pro Defense",
        icon = "def_weather_rain.png",
        description = "Forces rain conditions. All Pass plays lose -25% MTM.",
        hint = "Run the ball — the rain is killing your pass plays!",
    ...
    },
    {
        ...
        tier = "Pro Defense",
        icon = "def_standard.png",
        description = "Medium Pass -50% MTM and Short Pass -4 YDS. Deep Pass untouched.",
